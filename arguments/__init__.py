...
class ModelParams(ParamGroup):
    def __init__(self, parser, sentinel=False):
        ...
        self.pose_jitter_deg = 0.0
        self.pose_jitter_seed = 42
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.envmap_cubemap_lr = 0.02
        self.cubemap_resolution = 512

        self.env_start_iter = 0
        self.joint_training_start = 0
        ...
        self.no_normal_loss = False
        self.no_alpha_loss  = False
